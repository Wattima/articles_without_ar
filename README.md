...
## How to Use
Once you've run the run.rb file in the lib folder *(ruby run.rb)*, you can interact with the code by following the prompts in the terminal. The code includes the following classes and methods:
